 ...
 */
	...
	public static HttpHeaders header() throws JsonProcessingException {
		ApiHeader apiHeader = ApiHeader.builder().userDvcSeq(null).serialNo("SEO_SERIAL").cponId("phoneNo").build();
		ObjectMapper mapper = new ObjectMapper();
		String omnifitHeaderStr = mapper.writeValueAsString(apiHeader);
		HttpHeaders headers = new HttpHeaders();
		headers.setAccept(Arrays.asList(VisualkhhMediaType.OMNIFIT2_V1_JSON));
