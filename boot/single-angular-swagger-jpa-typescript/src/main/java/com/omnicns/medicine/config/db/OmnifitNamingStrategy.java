package com.omnicns.medicine.config.db;
...
public class OmnifitNamingStrategy extends PhysicalNamingStrategyStandardImpl implements PhysicalNamingStrategy, Serializable {
