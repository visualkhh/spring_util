...
//허리둘레	앞 1글자 까지만 표시 - 여러 건 노출 시 적용 (예) 3*.**
public class PrivacyWaistFormater  extends PrivacyEncryptor implements AttributeConverter<String, String>, AttributeViewControllConverter<String, String>{
	char mask = '*';
	@Override
