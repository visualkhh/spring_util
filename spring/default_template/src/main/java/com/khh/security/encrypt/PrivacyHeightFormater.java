...
//키	앞 2글자 까지만 표시 - 여러 건 노출 시 적용 (예) 16*.**
public class PrivacyHeightFormater  extends PrivacyEncryptor implements AttributeConverter<String, String>, AttributeViewControllConverter<String, String>{
	char mask = '*';
	@Override
